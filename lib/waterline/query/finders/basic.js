...
var compute = require('background-compute');
...
module.exports = {
  ...
  findOne: function(criteria, cb) {
    ...
    return compute.parallel.each(criteria.joins || [], 8, function(join) {
...
>>>>>>> 0a7af35ce972549c8046cbdc541a0d8077b694af
        ...
        function returnResults(results) {
          ...
          return compute.parallel.map(results, 8, function(result) {
            return self._transformer.unserialize(result);
          }).then(function(unserializedModels) {
            var models = [];
            var joins = criteria.joins ? criteria.joins : [];
            return new Joins(joins, unserializedModels, self.identity, self._schema.schema, self.waterline.collections)
              .then(function(data) {
                ...
                return compute.parallel.map(data.models, 8, function(model) {
